# File anotasi dari `run_train_historical_risk_patch_wsl_gpu.sh`.
...
# Komentar file skripsi: Script WSL untuk menjalankan training model historical_risk_patch dengan GPU.
# Catatan pada script terminal.
...
# Menjalankan script Python untuk training, evaluasi, atau dokumentasi.
exec "$VENV_DIR/bin/python" Ipynb/TRAIN_CONVLSTM_HISTORICAL_RISK_PATCH_1528x773_GOOGLE_COLAB.py "$@"
