# File anotasi dari `run_train_128_wsl_gpu.sh`.
...
# Komentar file skripsi: Script WSL untuk menjalankan training legacy ConvLSTM 128x128 dengan GPU.
# Catatan pada script terminal.
...
# Menjalankan script Python untuk training, evaluasi, atau dokumentasi.
exec "$VENV_DIR/bin/python" Ipynb/TRAIN_CONVLSTM_FINAL_GOOGLE_COLAB.py "$@"
